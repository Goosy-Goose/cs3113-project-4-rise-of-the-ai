...
public:
    ...
    //void face_left() { m_animation_indices = m_animations[LEFT]; }
    //void face_right() { m_animation_indices = m_animations[RIGHT]; }
    //void face_up() { m_animation_indices = m_animations[UP]; }
    //void face_down() { m_animation_indices = m_animations[DOWN]; }

    void move_left() { m_movement.x = -1.0f; /*if (m_current_animation != LEFT)*/ set_animation_state(LEFT); /*face_left();*/ }
    void move_right() { m_movement.x = 1.0f; /*if (m_current_animation != RIGHT)*/ set_animation_state(RIGHT); /*face_right();*/ }
